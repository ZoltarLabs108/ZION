...
| 7 | **AEGIS Tuesday-baseline cadence** (operational) | Tue 01:15 print + Wed catch-up guard fire reliably; no double-print | n/a (cadence already live) — revert if flaky | ~3-4 clean weekly cycles | verified once (08-18 manual) | watch Wed "catch-up SKIPPED" log through Sept |
